...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/include/firtex/config.h.in \
	$(top_srcdir)/test/testdata/conf/test_config_posix.xml.in \
...
CONFIG_CLEAN_FILES = test/testdata/conf/test_config_posix.xml
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/g/workspace/code/firtex2
abs_srcdir = /home/g/workspace/code/firtex2
...
include/firtex/config.h: include/firtex/stamp-h1
	@if test ! -f $@; then rm -f include/firtex/stamp-h1; else :; fi
	@if test ! -f $@; then $(MAKE) $(AM_MAKEFLAGS) include/firtex/stamp-h1; else :; fi

include/firtex/stamp-h1: $(top_srcdir)/include/firtex/config.h.in $(top_builddir)/config.status
	@rm -f include/firtex/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status include/firtex/config.h
$(top_srcdir)/include/firtex/config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f include/firtex/stamp-h1
	touch $@

distclean-hdr:
	-rm -f include/firtex/config.h include/firtex/stamp-h1
test/testdata/conf/test_config_posix.xml: $(top_builddir)/config.status $(top_srcdir)/test/testdata/conf/test_config_posix.xml.in
...
upload:
	make dist
	ncftpput -v upload.sourceforge.net /incoming firtex-0.5.0.tar.gz
